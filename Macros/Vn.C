...
void Vn()
{
        ...
        TGEtoCanvas(c1, "../Results/Vn/Vn_vs_Nch_2022.root", "V1", leg1, "2022", 801, ";N_{ch}^{j};V^{*}_{1#Delta}{2,|#Delta#eta^{*}|>2}");
        TGEtoCanvas(c1, "../Results/Vn/Vn_vs_Nch_2023.root", "V1", leg1, "2023", 417, ";N_{ch}^{j};V^{*}_{1#Delta}{2,|#Delta#eta^{*}|>2}");
        TGEtoCanvas(c1, "../Results/Vn/Vn_vs_Nch_2024CDEFG.root", "V1", leg1, "2024", 891, ";N_{ch}^{j};V^{*}_{1#Delta}{2,|#Delta#eta^{*}|>2}");
        TGEtoCanvas(c1, "../Results/Vn/Vn_vs_Nch_20run2.root", "V1", leg1, "Run2", 616, ";N_{ch}^{j};V^{*}_{1#Delta}{2,|#Delta#eta^{*}|>2}");
        ...
        TGEtoCanvas(c2, "../Results/Vn/Vn_vs_Nch_2022.root", "V2", leg2, "2022", 801, ";N_{ch}^{j};V^{*}_{2#Delta}{2,|#Delta#eta^{*}|>2}");
        TGEtoCanvas(c2, "../Results/Vn/Vn_vs_Nch_2023.root", "V2", leg2, "2023", 417, ";N_{ch}^{j};V^{*}_{2#Delta}{2,|#Delta#eta^{*}|>2}");
        TGEtoCanvas(c2, "../Results/Vn/Vn_vs_Nch_2024CDEFG.root", "V2", leg2, "2024", 891, ";N_{ch}^{j};V^{*}_{2#Delta}{2,|#Delta#eta^{*}|>2}");
        TGEtoCanvas(c2, "../Results/Vn/Vn_vs_Nch_20run2.root", "V2", leg2, "Run2", 616, ";N_{ch}^{j};V^{*}_{2#Delta}{2,|#Delta#eta^{*}|>2}");
        ...
        TGEtoCanvas(c3, "../Results/Vn/Vn_vs_Nch_2022.root", "V3", leg3, "2022", 801, ";N_{ch}^{j};V^{*}_{3#Delta}{2,|#Delta#eta^{*}|>2}");
        TGEtoCanvas(c3, "../Results/Vn/Vn_vs_Nch_2023.root", "V3", leg3, "2023", 417, ";N_{ch}^{j};V^{*}_{3#Delta}{2,|#Delta#eta^{*}|>2}");
        TGEtoCanvas(c3, "../Results/Vn/Vn_vs_Nch_2024CDEFG.root", "V3", leg3, "2024", 891, ";N_{ch}^{j};V^{*}_{3#Delta}{2,|#Delta#eta^{*}|>2}");
        TGEtoCanvas(c3, "../Results/Vn/Vn_vs_Nch_20run2.root", "V3", leg3, "Run2", 616, ";N_{ch}^{j};V^{*}_{3#Delta}{2,|#Delta#eta^{*}|>2}");
