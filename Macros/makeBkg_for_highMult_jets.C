void makeBkg_for_highMult_jets(){
    ...
    TFile* f= new TFile("../Dokumente/ana_run3_allNch_2024_Jet275_310_550.root","READ");
    ...
    TFile* fout= new TFile("../Dokumente/ana_run3_allNch_2024_Jet275_310_550_newBkg_for_high_Nch.root","RECREATE");
