...
void SBRatio_char(int baseline_Jahr = 22, TString test_Jahr = "22C")
{
    ...
    TFile *file_2 = new TFile(Form("../Dokumente/ana_run%d_allNch_20", num_run) + test_Jahr + ".root", "read");
    ...
    for (int i = 0; i < 10; i++)
    {
        for (int j = 0; j < 2; j++)
        {
            ...
            hSignal_ratio[i][j]->SetTitle(Form("%d<Nch<%d, %.2f<jT<3 GeV/c, Signal;#Delta#phi*;count 20" + test_Jahr + " / count 20%d", trackbinbounds[i], trackbinboundsUpper[i], ptname[j], baseline_Jahr));
            ...
            hBkg_ratio[i][j]->SetTitle(Form("%d<Nch<%d, %.2f<jT<3 GeV/c, Background;#Delta#phi*;count 20" + test_Jahr + " / count 20%d", trackbinbounds[i], trackbinboundsUpper[i], ptname[j], baseline_Jahr));
    ...
    cSignal_1->SaveAs(Form("../Figuren/year_ratios/Signal_canvas1_20" + test_Jahr + "to20%d.pdf", baseline_Jahr));
    ...
    cSignal_2->SaveAs(Form("../Figuren/year_ratios/Signal_canvas2_20" + test_Jahr + "to20%d.pdf", baseline_Jahr));
    ...
    cBkg_1->SaveAs(Form("../Figuren/year_ratios/Background_canvas1_20" + test_Jahr + "to20%d.pdf", baseline_Jahr));
    ...
    cBkg_2->SaveAs(Form("../Figuren/year_ratios/Background_canvas2_20" + test_Jahr + "to20%d.pdf", baseline_Jahr));
    ...
    cSignal_ind_2_1->SaveAs("../Figuren/S_und_B/Signal_canvas1_20" + test_Jahr + ".pdf");
    ...
    cSignal_ind_2_2->SaveAs("../Figuren/S_und_B/Signal_canvas2_20" + test_Jahr + ".pdf");
    ...
    cBkg_ind_2_1->SaveAs("../Figuren/S_und_B/Background_canvas1_20" + test_Jahr + ".pdf");
    ...
    cBkg_ind_2_2->SaveAs("../Figuren/S_und_B/Background_canvas2_20" + test_Jahr + ".pdf");
}
